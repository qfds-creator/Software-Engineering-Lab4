...
提交打包
- 请将 `实验报告.pdf`、`AIGC检测_实验报告.pdf`、`UML/` 与 `code/`（把 src/ 放进 code/）等文件放在项目根并使用之前提供的打包脚本生成 zip 文件：`实验3_学号_姓名.zip`。

如需我把该项目打包成 zip 并生成可下载内容，或把代码推到你的 GitHub 仓库（你需提供仓库权限/链接），我可以继续协助。
```